...
<template>
  <div
    class="component-root bg-background shadow-lg border border-solid border-orange-100 max-w-2xl w-[96%] p-6 rounded-xl"
  >
    <div class="flex items-center gap-3">
      <Plus class="text-primary" size="24" />
      <p class="font-medium text-text text-lg">新しいメモ</p>
    </div>
    <form @submit.prevent="handleSubmit">
      ...
      ></textarea>
      <button
        class="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-primary to-secondary rounded-xl mt-4 p-3 disabled:cursor-not-allowed disabled:opacity-40"
